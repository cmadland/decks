...
\textgreater Pellegrino, J. W., Chudowsky, N., \& Glaser, R. \emph{Knowing What Students Know: The Science and Design of Educational Assessment}. National Academies Press. \url{https://doi.org/10.17226/10019}
...
The final component of assessment is an inference or interpretation of the data generated by the assessment instrument. The accuracy of the interpretation depends on how well the instrument aligns with the cognitive model (validity) and how stable the results are across populations (reliability).

\begin{reflect}
One important thing to note is that many higher ed instructors (outside
of faculties of education or psychology) do not have formal preparation
in educational assessment, \emph{however}, higher education instructors
\emph{do} have extensive background and preparation for conducting
research. The assessment triangle above has many parallels to research
(cognitive model/literature review; instrument to gather data;
...
\caption{A Framework for Assessment as described below.}
\end{figure}

DeLuca et al.'s model for assessment comprises four dimensions, each with three priority themes. Each of these dimensions influence the other dimensions, and all influence instructors' approaches to assessment. The term `approaches to assessment' is intended to convey the reality that assessment in formal education is tremendously complex and idiosyncratic. Assessment literacy is not a checklist of competencies, `best' practices, or rules.

References

Pellegrino, J. W., Chudowsky, N., \& Glaser, R. (2001). Knowing What Students Know: The Science and Design of Educational Assessment. National Academies Press. \url{https://doi.org/10.17226/10019}

Weeks, K. W., Coben, D., O'Neill, D., Jones, A., Weeks, A., Brown, M., \& Pontin, D. (2019). Developing and integrating nursing competence through authentic technology-enhanced clinical simulation education: Pedagogies for reconceptualising the theory-practice gap. Nurse Education in Practice, 37, 29--38. \url{https://doi.org/10.1016/j.nepr.2019.04.010}
